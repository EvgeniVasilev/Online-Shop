...
<div class="container-fluid window">
    <form method='post' action="checkout_two.php?item_id=<?php echo $id; ?>&tbl_name=<?php echo $table; ?>" class='col-lg-6 col-md-6 col-sm-8 col-lg-offset-3 col-md-offset-3 col-sm-offset-2'>
        ...
        <div class='form-group'>
            ...
            <br/>
            <br/>
            <input id='first-name' name='first-name' type="text" class='form-control' value="Some" required="">
        </div>
        <div class='form-group'>
            <label for='second-name' class='label label-primary form-control'>SECOND NAME</label>
            <br/>
            <br/>
            <input id='second-name' name='second-name' type="text" class='form-control' value="Some" required="">
        </div>
        <div class='form-group'>
            <label for='ship-address' class='label label-primary form-control'>Shipping Address</label>
            <br/>
            <br/>
            <input id='ship-address' name='ship-address' type="text" class='form-control' value="Some" required="">
        </div>
        <div class='form-group'>
            <label for='ship-address-two' class='label label-primary form-control'>Shipping Address Two</label>
            <br/>
            <br/>
            <input id='ship-address-two' name='ship-address-two' type="text" class='form-control' value="Some" required="">
        </div>
        <div class='form-group'>
            <label for='city' class='label label-primary form-control'>City</label>
            <br/>
            <br/>
            <input id='city' name='city' type="text" class='form-control' value="Some" required="">
        </div>
        <div class='form-group'>
        ...
        <div class='form-group'>
            ...
            <br/>
            <br/>
            <input id='email' name='email' type="text" class='form-control' value="some@abv.bg" required="">
        </div>
        <div class='form-group'>
