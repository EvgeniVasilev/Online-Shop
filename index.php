...
<div class="container-fluid  window">
    <div id="myCarousel" class="carousel slide col-lg-6 col-md-6 col-sm-6" data-ride="carousel" style="padding: 13px;">
        <!-- Indicators -->
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="http://thumb1.shutterstock.com/display_pic_with_logo/1428518/204877840/stock-photo-young-beautiful-women-at-the-weekly-cloth-market-best-friends-sharing-free-time-having-fun-and-204877840.jpg"  alt="Flower" class="img">
            </div>

            <div class="item">
                <img src="http://thumb7.shutterstock.com/display_pic_with_logo/459187/156198461/stock-photo-background-with-shoes-on-shelves-of-shop-156198461.jpg" alt="Chania" class="img">
            </div>

            <div class="item">
                <img src="http://thumb7.shutterstock.com/display_pic_with_logo/2403095/209979001/stock-photo-jewelry-window-display-209979001.jpg" alt="Flower" class="img">
            </div>          
    ...
    <div  class="carousel slide col-lg-6 col-md-6 col-sm-6 padded-13">        
        <div class="carousel-inner hidden-xs" role="listbox">
            <div class="item active">
                <img src="http://thumb9.shutterstock.com/display_pic_with_logo/579082/579082,1271010336,2/stock-photo-children-playing-with-blocks-on-the-floor-focus-on-the-boy-s-face-50844475.jpg" alt="Flower" class="img">
            </div>
        </div>  
    </div>
